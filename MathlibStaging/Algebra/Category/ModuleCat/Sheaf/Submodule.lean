...
presheaf of modules whose membership is *local*. The associated presheaf of modules
`N.toPresheafOfModules` is then again a sheaf, giving `N.toSheafOfModules`. This is the general
glue used to construct subobjects of sheaves of modules from submodules of the underlying
presheaf of modules.
